...
const infosSaintGobainAnalyzer = {
  ...
  video: '427639516',
  results: {
    fr: 'UtilisÃ© par Saint-Gobain pour faire avancer la recherche sur la reprÃ©sentation du confort thermique, dans le cadre de lâ€™initiative Multi-Comfort\u00A0Buildings.',
  ...
  chapo: {
    fr: 'Faire ressentir le confort thermique dâ€™un logement Ã  partir de donnÃ©es de simulation physique.',
    en: 'Make people feel the thermal comfort of a home from physical simulation data.'
  },
  quote: {
    fr: 'Lâ€™Ã©quipe Dataveyes a su nous Ã©couter et a rÃ©ussi Ã  bien cerner notre problÃ©matique. Elle nous a apportÃ© une maniÃ¨re diffÃ©rente dâ€™apprÃ©hender le sujet, en appliquant une mÃ©thodologie trÃ¨s professionnelle, et en faisant preuve dâ€™agilitÃ© dans le dÃ©veloppement de lâ€™application.',
    en: 'The Dataveyes team listened to our needs and identified our challenge successfully. They shined a new light on the problem, by applying a very professional process and remaining agile during the applicationâ€™s development.',
    author: {
