...
const infosDVCompagnon = {
  ...
  video: '426955466',
  results: {
    fr: 'CitÃ© dans plusieurs ouvrages sur les bonnes pratiques design.',
    en: 'Cited in several books on good design practices.'
  },
  chapo: {
    fr: 'Prouver quâ€™une application bien conÃ§ue peut aider le grand public Ã  mieux gÃ©rer sa consommation d\'Ã©lectricitÃ©.',
