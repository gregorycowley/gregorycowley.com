...
const infosSidLeeWatchDog = {
	...
	client: "Sid Lee Paris",
	label: "Predictive World - Data visualization",
	theme: {
		isDark: true,
		background: "#251F2E"
	},
	video: "427808862",
	chapo: "Imagine visualization concepts that are aesthetic and meaningful, as well as consistent with the data.",
	category: "Prototype",
	date: "2016 - 0.5 month",
	carousel: {
		isBig: false,
