...
const infosBloomOutilSaas = {
	...
	client: "Bloom",
	label: "Visualization of social graphs",
	theme: {
		isDark: true,
		background: "#0D1136"
	},
	video: "426967283",
	results: "'I find it really cool, it's starting to speak to me.'  'I found the tool intuitive, simple.' â€”Quotes from users who tested our redesign of the tool.",
	chapo: "Facilitate the use and understanding of algorithms for analyzing conversations on social media.",
	category: "Tool",
	date: "2019 & 2020",
	carousel: {
		isBig: false,
