...
const infosSwisscomMobilityInsights = {
  ...
  label: {
    fr: 'Comment la Suisse se dÃ©place\u00A0?',
  ...
  chapo: {
    fr: 'Rendre perceptible la valeur des donnÃ©es de tÃ©lÃ©communication pour mieux comprendre les dÃ©placements de population.',
    en: 'Conveying the value of Swisscomâ€™s mobility data to better understand urban mobility.'
  },
  category: {
    fr: 'Prototype',
    en: 'Prototype'
