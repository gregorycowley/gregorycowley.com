...
const infosEDFMaquettePedagogique = {
	...
	client: "EDF R&D",
	label: "Flexible energy simulator",
	theme: {
		isDark: true,
		background: "#15153E"
	},
	video: "427637151",
	results: "Projected on a big screen in several EDF showrooms.",
	chapo: "Use an educational simulator to highlight the importance of energy flexibility.",
	caseStudy: {
		en: {
