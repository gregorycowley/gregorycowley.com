...
const infosMalakoffMedericBarometre = {
	...
	label: "Measuring quality of life at work",
	theme: {
		isDark: true,
		background: "#0A103C"
	},
	video: "427637944",
	results: "Site visitors view an average of 5 pages per session.",
	src: {
	...
	chapo: "Foster the sharing and reuse of data via an open data platform for the general public.",
	quote: "With their professionalism and combined expertise in communication and data processing, Dataveyes has enabled us to strengthen our value proposition in terms of bettering understanding human capital.",
	author: {
		name: "Marc Fargeas",
		position:"Monitoring, Prospective, Strategic Studies Manager, Malakoff Humanis",
	},
	category: "Opendata platform",
	date: "2018 - 4 months",
	carousel: {
		isBig: false,
