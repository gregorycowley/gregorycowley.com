...
import { headerHeight, headerHeightMobile } from "components/_layout/Header/constants";
import mq from "common/styles/breakpoints";
import ArrowLeftWithDisc from "assets/icons/ArrowLeftWithDisc";
import { Title4, TitlePage } from "components/_ui/Titles";
...
const Border = styled.div(
	({ theme, isDarkTheme }) => {
		const bgColor = isDarkTheme ? theme.separatorLightColor : theme.separatorColor;
		return css`
      grid-column: 2 / -2;
