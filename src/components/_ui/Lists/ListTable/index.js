...
const Tr = styled("tr")(
    ...
    border-top: 1px solid
      ${isDarkTheme ? theme.separatorLightColor : theme.separatorColor};
    ${mq("small")} {
      display: block;
    }
  `
...
const Text = styled(Paragraph1)(({ isHighlighted, isDarkTheme, theme }) => {
	const colorDark = isHighlighted ? theme.white : theme.secondaryColor;
	const colorLight = isHighlighted ? theme.black : theme.secondaryColor;
	return css`
