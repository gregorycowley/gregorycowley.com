	...
	render() {
		...
		return (
			<div className="image-carousel">
				...
				<CarouselItem
					index="1"
					activeState={this.state.items[0].active}
					imgSrc={this.state.items[0].src}
				/>
				<CarouselItem
					index="2"
					activeState={this.state.items[1].active}
					imgSrc={this.state.items[1].src}
				/>
				<CarouselItem
					index="3"
					activeState={this.state.items[2].active}
					imgSrc={this.state.items[2].src}
				/>
				<CarouselItem
					index="4"
					activeState={this.state.items[3].active}
					imgSrc={this.state.items[3].src}
				/>
				<CarouselItem
					index="5"
					activeState={this.state.items[4].active}
					imgSrc={this.state.items[4].src}
				/>
			</div>
		);
	}
...
class CarouselItem extends React.Component {
	...
	render() {
		return (
			<div
				className={`carousel-item carousel-item--${this.props.index} ${this.props.activeState}`}
			>
