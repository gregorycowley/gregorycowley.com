...
const infosMetrolabODsee = {
  ...
  video: '427804567',
  results: {
    fr: 'ODsee a Ã©tÃ© utilisÃ© par RATP Dev Ã  Casablanca, au Maroc, pour optimiser l\'offre de transport pendant certaines pÃ©riodes, comme le Ramadan.',
  ...
  chapo: {
    fr: 'ModÃ©liser et visualiser des millions de trajets en transports en commun pour mieux adapter lâ€™offre de transport Ã  la demande.',
