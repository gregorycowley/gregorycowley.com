...
const MichelinDDI = () => {
  ...
  console.log("MichelinDDI", imgGallery1);
...
const infosMichelinDDI = {
  ...
  video: '427638306',
  results: {
    fr: 'PrÃ©sentÃ© Ã  l\'exposition Designer(s) du Design, dans le cadre de Lille capitale mondiale du design 2020',
    en: 'Presented at the Design designer(s) exhibition, part of the \'Lille World Design Capital 2020\'.'
  },
  chapo: {
    fr: 'Montrer comment les donnÃ©es de 50\u00A0000 conducteurs connectÃ©s peuvent aider Ã  amÃ©liorer les routes.',
