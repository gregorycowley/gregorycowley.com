...
const infosDigimindSuggest = {
  ...
  video: '427804937',
  results: {
    fr: 'Lancement dâ€™un nouveau produit dâ€™e-rÃ©putation.',
    en: 'Launch of a new online reputation product.'
  },
  chapo: {
    fr: 'Repenser le design dâ€™un outil de suivi dâ€™e-rÃ©putation pour le rendre plus facile Ã  lire et Ã  utiliser.',
